...
<div class="content-wrapper">
	...
	<div class="box box-primary">
		<div class="col-lg-7">
			...
			<div class="newpost" style="padding: 15px; margin: 5px 0 22px 0;">
				<form method="POST" action="update_posting.php">
					...
					<table>
						...
						<tr>
							...
							<td>
								<select id="kategori" name="id_kategori">
									<option value="0">--Pilih Biro dan Desk--</option>
						...
						<tr>
							...
							<td></td>
							<td>
								<button type="submit" class="btn btn-secondary">Edit Berita</button>
							</td>
						</tr>
					</table>
				</form>
