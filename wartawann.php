  ...
  <div class="box box-primary">
    <div class="col-lg-7">
     <div class="box-header with-border">
      <h1>Input Berita Teks</h1>
    </div>
    
        <div class="newpost">

          <form role="form" method="POST" action="Create_posting.php" enctype='multipart/form-data'>
            <input type='file' name='file' /><br>
            <div class="form-group my-3 w-50">
              <tr>
                <label for="judul">Judul</label>
                <td>:</td>
                <td><input name="judul" id="judul" cols="105" rows="1" class="form-control" required="required" placeholder="Tulis Judul Berita" ></td>
              </tr>
            </div>
            <div class="form-group my-3 w-50">
              <tr>
                <label for="kategori">Biro dan Desk</label>
                <td>:</td>
                <td>
            ...
            <div class="form-group my-3 w-50">
              <tr>
                ...
                <td><textarea name="deskripsi" cols="105" rows="10" placeholder="Tulis Isi Berita" class="form-control" required="required"></textarea></td>
              </tr> 
            </div>  
