	...
	<div class="box box-primary">
		<div class="col-lg-7">
			...
			<div id="content" class="col-lg-10">
				<?php $select = mysqli_query($koneksi, "SELECT `no_induk`,`nama`,`status`,`last_login`, `password` FROM `anggota` WHERE `no_induk` = '".$_GET['no_induk']."'");
				?>
				<?php
				if(mysqli_num_rows($select)){
					while ($baris = mysqli_fetch_array($select)){
						...
						<form role="form" method="POST" action="update_member.php?no_induk=<?php echo $baris['no_induk']; ?>">
							<div class="form-group my-3 w-50">
								<label for="nama">Nama</label>
								<input name="nama" type="text" class="form-control" required="required" value="<?php echo $baris['nama']; ?>">
							</div>
							<div class="form-group my-3 w-50">
								<label for="no_induk">NIP</label>
								<input name="no_induk" type="text" class="form-control" required="required" value="<?php echo $baris['no_induk']; ?>">
							</div>
							<div class="form-group my-3 w-50">
								<label for="password">Password</label>
								<input name="password" type="text" class="form-control" required="required" value="<?php echo $baris['password']; ?>">
							</div>
							<input name="status" type="hidden" class="form-control" value="<?php echo $baris['status'];?>">
