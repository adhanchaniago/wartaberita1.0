	...
	<div class="box box-primary">
		<div class="col-lg-7">
			...
			<div class="card shadow mb-4">
				<?php $select = mysqli_query($koneksi, "SELECT `no_induk`,`nama`,`status`,`last_login` FROM `anggota` UNION SELECT `no_induk`,`nama`,`status`,`last_login` FROM `anggota` WHERE `nama` NOT IN ('administrator')"); ?>
				<div class="card-header py-3">
				
				</div>
				<h1>Kelola Akun</h1>
				<br>
				<a href="create_member.php"><button class="btn btn-primary"> + TAMBAH AKUN </button></a>
				<br>
				<br>
									...
									while ($baris = mysqli_fetch_array($select)) {
										...
										<tr>
											...
											<td scope="col"><a href="edit_member.php?no_induk=<?php echo $baris['no_induk']?>">
												<button class="btn btn-sm btn-outline-secondary">Edit</button></a></td>
												<td><button class="btn btn-sm btn-outline-danger" type="text-center" onclick="<?php echo "".$baris['status']."".$baris['no_induk']."";?>()">
													Delete</button></td>
