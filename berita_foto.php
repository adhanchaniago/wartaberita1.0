...
$query = "SELECT p.*, k.nama_kategori FROM `posting_berita_foto` p LEFT JOIN `kategori` k ON p.id_kategori = k.id_kategori WHERE p.`no_induk` = '".$_SESSION['current_id']."'";
...
<body class="hold-transition skin-green sidebar-mini">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="berita_foto.php"><i class="fa fa-circle-o"></i> Berita Foto</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
      ...
      <li><a href="ganti_foto_profil"><i class="fa fa-circle-o text-yellow"></i> <span>Ubah Foto Profil</span></a></li>
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Input Berita Foto</li>
    </ol>
  </section>
    ...
    <?php if (isset($_SESSION['errors'])){ ?>
      ...
      <?php if (isset($_SESSION['success'])){ ?>
        ...
        <div class="newpost">
          ...
          <form action="upload_berita_foto.php" method="POST" enctype="multipart/form-data" name="form1" id="form1">
            <div class="form-group">
              <tr>
                <label for="judul">Judul</label>
                <td>:</td>
                <input type="text" class="form-control" name="judul" id="judul" required="required" placeholder="Tulis Judul Berita">
              </tr>
            </div>
